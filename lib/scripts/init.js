...
const {resolve} = path;
//
const { logError,getPadLength, runGenerator,getGeneratorMeta } = require('../BasicUtil');
const {getGitBranchFiles,getGitBranchInfo} = require('../BasicUpdate');
// questions
const questions = {
  isCoverd: {
    name: 'isCovered',
